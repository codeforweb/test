    ...
    PAYPAL.Marketing.HeaderMenu.prototype = {
        ...
        _toggleMenu: function(e)
        {
            ...
            else if (this._$menu.find('.menu-wrapper.open').length > 0)
            {
                ...
                // Fire GA event
                if (ga) ga('send', 'event', 'MPP Header Drawer', 'Open', selectedItem.text());
            }
            // Open one
            else
            {
        ...
        _toggleState: function(e)
        {
            ...
            else
            {
                ...
                // Fire GA event
                if (ga) ga('send', 'event', 'MPP Mobile Menu', 'Open');
            }
        },
        ...
        _showNextStep: function(form)
        {
            ...
            // Fire GA event
            //if (ga) ga('send', 'event', 'mpp-header-menu', 'show-step', curs+2);
        },
...
$(function()
{
    var sideMenu,
        ...
        signupButtonInner = $('#signup-button-inner'),
        insideLoginButton = $('#login-header > form > input[type="submit"]'),
        modalLoginButton = $('#login-modal-1 > form input[type="submit"]'),
        modalSignupButton = $('#login-modal-1 > form a[name="SignUp_header"]'),
    ...
    if ($(document.documentElement).data('device-type') !== 'dedicated')
    {
        ...
        // Listen for modal
        /* 
        // commenting this out since it caused a major issue on live with
        // the login modal scrolling out of view when login button was clicked
        ...
        modalSignupButton.on('mousedown', function(e) {
            // Fire ga event
            if (ga) ga('send', 'event', 'MPP Sign-Up Button', 'Modal');
        });
    }
    // Show login form
    else
    {
        signupButton.on('mousedown', function(e) {
            // Fire ga event
            if (ga) ga('send', 'event', 'MPP Sign-Up Button', 'Outer');
        });

        signupButtonInner.on('mousedown', function(e) {
            // Fire ga event
            if (ga) ga('send', 'event', 'MPP Sign-Up Button', 'Inner');
        });
